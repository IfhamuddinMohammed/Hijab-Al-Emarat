...
const IMG = {
  abaya1: "https://res.cloudinary.com/df4autxjg/image/upload/v1751638933/ROYAL_BLACK_ABAYA_hrx8kd.png",
  abaya2: "https://res.cloudinary.com/df4autxjg/image/upload/v1751634770/Hjb1_bsiwjl.jpg",
  silk:   "https://res.cloudinary.com/df4autxjg/image/upload/v1751638940/SILK_a4ceiv.png",
  jersey: "https://res.cloudinary.com/df4autxjg/image/upload/v1751638474/Hijabs_zoej9q.png",
  niqab:  "https://res.cloudinary.com/df4autxjg/image/upload/v1751638483/Niqabs_xwxnxb.png",
  acc:    "https://res.cloudinary.com/df4autxjg/image/upload/v1751638633/accessories_ikyfjt.png",
};
  ...
  const [products, setProducts] = useState<Product[]>(() => {
    try {
      ...
      if (stored) {
        ...
        // Backfill new optional fields for legacy stored products
        return parsed.map(p => {
